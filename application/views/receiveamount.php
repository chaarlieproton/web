...
?>
        ...
        <?php } ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          ...
                          <div class="input-group">
                            <input type="hidden" disabled="disabled" class="form-control">
			  ...
			  <td style="width:10%"><?php echo $i; ?></td>
                          <td style="width:50%"><?php echo $qrdetail; ?></td>
                          <td style="width:40%">
                          	<a href="javascript:;" data-toggle="modal" data-target="#myModal" onclick="qrcodepop('<?php echo $qrdetail;?>');"><img src="http://chart.apis.google.com/chart?cht=qr&chs=300x300&chl=<?php echo $qrdetail;?>" style="width:10%;"></td>
                          </tr>
                          <?php $i++;}?>
