...
<html lang="en">
  ...
  <body class="login" style="background: url('<?php echo admin_login_bg();?>') no-repeat center center fixed !important;  -webkit-background-size: cover;
  ...
  background-size: cover !important;">
    <div>
      ...
      <div class="login_wrapper">
        ...
        <?php } ?>
          <section class="login_content" style="    background-color: #9d2914;
    padding: 12px;">
            <form action="<?php echo base_url()?>admin/login/login" method="POST"  id="loginform">
              <h1><img src="<?php echo logo_url() ?>" style="width: 59%;"></h1>
              <div>
