          ...
          <div class="left_col scroll-view">
             <div class="navbar nav_title" style="border: 0;">
              ...
              <a href="<?php echo admin_url()?>dashboard" class="site_title">
                <img src="<?php echo logo_url() ?>" alt="<?php echo project_name();?>" id="desklogo" class="img-circle profile_img" style="  background-image: linear-gradient(to left top, #f17e2a, #f48f46, #f69f60, #f7af7a, #f7be95);">
                 </a>
            </div>
 ...
 -->
             <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <h3>Useful Links</h3>
                 <ul class="nav side-menu">
              <li><a href="<?php echo admin_url();?>userdetail"><i class="fa fa-user"></i> User Detail</a></li>     
