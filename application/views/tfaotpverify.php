        ...
        <?php } ?>
          <section class="login_content">
            <form action="<?php echo base_url()?>tfaotpverify/verify" method="POST"  id="otpform">
              ...
              <div>
                <input type="text" class="form-control validate[required,maxSize[6],custom[onlyNumberSp]]" placeholder="TOtp" id="totp" name="totp" maxlength="6" />
              </div>
              

              <div>
                <button type="submit" class="btn btn-success" onclick="return formbtn();" style="color: #000;background-color: #fff;">Submit</button>              
